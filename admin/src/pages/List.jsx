  ...
  return (
    <>
      <div className='mb-4 inline-flex gap-3 items-center'>
        <h3 className='font-semibold text-amber-500'>All Products List</h3>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <div className='hidden md:grid grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center py-1 px-2 border border-amber-400 bg-gray-100 text-sm'>
          <b>Image</b>
          <b>Name</b>
          <b>Category</b>
          <b>Price</b>
